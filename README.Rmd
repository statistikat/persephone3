...
This package is an object oriented wrapper around the R Packages in the rjdverse \url{https://github.com/rjdverse/}, which performs
...
devtools::install_github("statistikat/persephone/tree/persephone3")

# optional: also install vignettes (needs prettydoc)
# devtools::install_github("statistikat/persephone3", build_vignettes = TRUE)
```
...
The original output from [`rjd3x13::x13_fast`] or [`rjd3tramoseats::tramoseats_fast`] can be inspected via the `output` field.
