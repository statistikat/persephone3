#' Generate summary statistics for persephone objects
#'
#' This function creates a summary table of the most important diagnostics.
#' This is used internally by the R6 method and S3 method.
#'
...
#' Summary table for persephone objects
#'
#' Creates a summary table using the iterate mechanism for hierarchical objects
#'
#' @param x a persephone object
#' @return data.frame with summary statistics
summaryTable <- function(x) {
  x$iterate(generate_summary, asTable = TRUE)
}

#' S3 summary method for persephone objects
#'
#' @param object a persephone object
#' @param ... additional arguments (currently unused)
#' @return A data.frame with quality report statistics
#' @export
summary.persephone <- function(object, ...) {
  summaryTable(object)
}

#' @export
summary.perX13 <- function(object, ...) {
  summaryTable(object)
}

#' @export
summary.perTramo <- function(object, ...) {
  summaryTable(object)
}

#' @export
summary.perHts <- function(object, ...) {
  summaryTable(object)
}
